...
class MainMenu:
    def __init__(self, root):
        ...
        icon_image = tk.PhotoImage(file="LanguageHUB_icon.png")  # Replace "icon.png" with the actual file path
        resized_icon = icon_image.subsample(6, 6)  # Adjust the subsample values to resize the image
        ...
        welcome_label.pack(pady=0)  # Increase the space after the label
        ...
        text_translation_button.pack(pady=20)  # Add space after the button
        ...
        document_translation_button.pack(pady=20)  # Add space after the button
        ...
        recording_translation_button.pack(pady=20)  # Add space after the button

        close_button = tk.Button(root, text="Close", command=self.close_window, **close_button_style)
        close_button.pack(side=tk.LEFT, anchor=tk.SW, padx=10, pady=10)  # Align to left bottom corner

    def text_translation(self):
        text_translation_window = tk.Toplevel(self.root)
        app = texttranslator_window(text_translation_window)

    def document_translation(self):
        # Placeholder for the document translation functionality
        doc_translation_window = tk.Toplevel(self.root)
        app = doctranslator_window(doc_translation_window)
    def record_translation(self):
        # Placeholder for the text translation functionality
        messagebox.showinfo("Recording Translation", "This feature will be coming soon. Stay tuned!")
    def close_window(self):
        # Display a confirmation message before closing the window
        if messagebox.askokcancel("Confirmation", "Are you sure you want to close LanguageHUB?"):
            self.root.destroy()  # Make sure to install the required library
...
class texttranslator_window:
    def __init__(self, root):
        ...
        self.root.configure(bg="#001F3F")  # Set background color

        # Add a frame at the top with the text 'languageHUB'
        ...
        icon_image1 = tk.PhotoImage(file='LanguageHUB_icon.png')  # Replace with your image path
        resized_image1 = icon_image1.subsample(7, 7)  # Adjust the subsample values as needed
        ...
        icon_image2 = tk.PhotoImage(file='LanguageHUB_icon.png')  # Replace with your image path
        resized_image2 = icon_image2.subsample(7, 7)  # Adjust the subsample values as needed
        ...
        white_frame = tk.Frame(self.root, bg="white", height=3, width=750)  # Adjust the width as needed
        white_frame.place(relx=0, rely=0.17, anchor="nw")

        # Add a close button at the bottom left corner
