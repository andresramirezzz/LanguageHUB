...
class texttranslator_window:
    def __init__(self, root):
        ...
        self.textbox1 = Text(root, width=32, height=10, borderwidth=4, font=('DIN Alternate', 14), pady=5, relief=RIDGE)
        self.textbox1.place(x=20, y=170)
        self.textbox2 = Text(self.root, width=32, height=10, borderwidth=4, font=('DIN Alternate', 14), pady=5, relief=RIDGE)
