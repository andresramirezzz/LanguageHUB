...
class LanguageHUB:
    def __init__(self, root):
        ...
        title_button_style = {"font": ("Arial", 16, "bold"), "fg": "#001F3F", "bg": "#001F3F", "relief": tk.GROOVE, "bd": 3, "padx": 15, "pady": 10}
        close_button_style = {"font": ("Arial", 12, "bold"), "fg": "#001F3F", "bg": "#001F3F", "relief": tk.GROOVE, "bd": 3, "padx": 10, "pady": 5}
...
class texttranslator_window:
    def __init__(self, root):
        ...
        close_button_style = {"font": ("DIN Alternate", 12, "bold"), "fg": "#001F3F", "bg": "#001F3F", "relief": tk.GROOVE, "bd": 3, "padx": 10, "pady": 5}
...
class doctranslator_window:
    def __init__(self, root):
        ...
        other_button_style = {"font": ("DIN Alternate", 18, "bold"), "fg": "#001F3F", "bg": "#001F3F", "relief": tk.GROOVE, "bd": 3, "padx": 10, "pady": 5}
